...
data['job'].replace(['unemployed',  'student', 'unknown', 'blue-collar','management','technician','admin.','services','retired', 'self-employed','entrepreneur', 'housemaid' ],[0,0,0,1,1,1,1,1,2,3,4,5], inplace=True)
